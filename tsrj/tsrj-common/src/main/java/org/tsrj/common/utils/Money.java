...
public class Money implements Serializable, Comparable<Object> {
	 ...
	 * getDisplayUnit(LocaleUtil.getContext().getLocale()); }
	 *//**
	 ...
	 */
	/*
	 * public String getDisplayUnit(Locale e) { if (e == null) { e =
	 * LocaleUtils.getContext().getLocale(); } String currencyCode =
	 * getCurrencyCode(); //得到語言相關的貨幣單位對炤錶，如果沒有，使用默認語言 Map cMap =
	 * (Map)CURRENCY_DISPLAY_UNIT_MAP.get(e.toString()); if (cMap == null) {
	 * cMap = (Map)CURRENCY_DISPLAY_UNIT_MAP.get(DEFAULT_LOCALE); }
	 * //得到貨幣單位，如果沒有找到，使用貨幣Code返囬 String displayUnit =
	 * (String)cMap.get(currencyCode); if (displayUnit == null) { displayUnit =
	 * currencyCode; } return displayUnit; }
	 */
