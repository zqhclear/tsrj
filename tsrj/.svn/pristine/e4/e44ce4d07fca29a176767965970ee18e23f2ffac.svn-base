...
public class MqConfig {
     ...
     */
    public static final String TOPIC = "kongming";
    public static final String PRODUCER_ID = "PID_qwe";
    public static final String CONSUMER_ID = "CID_qwe";
/*  public static final String ORDER_TOPIC = "XXX";
    ...
    public static final String ACCESS_KEY = "LTAIRCuFyR3mP8dz";
    public static final String SECRET_KEY = "2I9Aza7IySgOBFv2KSIiOXs77l8S9N";
